...
<div x-data="{
                ...
                <tbody>
                    @foreach ($record->block->classes as $class)
                        ...
                        <tr class="text-sm border-b border-gray-200">
                                ...
                                <td class="px-4 py-3">{{ $schedule->day }} {{ date('g:i A', strtotime($schedule->start_time)) }}
                                {{_("-")}} {{ date('g:i A', strtotime($schedule->end_time)) }}
                            </td>
    ...
    <div class="flex items-center justify-center text-center">
        ...
        <span class="font-medium">Follow steps one to four below. Failure to comply with a step prohibits you from proceeding forward with the request.</span>
    </div>
</div>
        <!-- Main content -->
                            ...
                            <div class="flex justify-between mt-4">
                                ...
                                <button type="button"
                                 ...
                                 <button type="button"
                                    ...
                                    Proceed to Submission of Documents
                                </button>
                            </div>
                        </div>
                    </div>
